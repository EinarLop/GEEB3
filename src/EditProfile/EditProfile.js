...
export default function EditProfile() {
    ...
    const [colleges, setColleges] = useState([      // retrieve from database "colleges" collection
        "ITESM",
        "UNAM",
        "IPN",
        "ITAM",
...
//onChange ***************************************************************************************************************************
    const handleOnChange = (e) =>{      // generic handler for our inputs
        setProfile({
            ...profile,
    ...
    return (
        <div className={styles.Wrapper}>
            ...
            <div className={styles.EducationWrapper}> 
                ...
                <input className={styles.InputSmall} type="" placeholder=" e.g. Computer Science"/>
            </div>
            ...
            <input className={styles.InputSmall} onChange={handleOnChange} name="mastered"/>
            <input type="button" value="Adds"className={styles.Button} onClick={onAddTagMastered} />
            
            <div className={styles.MasteredTagContainer}> 
            {mastered.map((masteredTag) => (<div>{masteredTag}</div>))}
            </div>
            ...
            <input className={styles.InputSmall} onChange={handleOnChange} name="learning"/>
            <input type="button" value="Adds"className={styles.Button}  onClick={onAddTagLearning}/>
            <div className={styles.LearningTagContainer}> 
            {learning.map((learningTag) => (<div>{learningTag}</div>))}
            </div>
            </div>
            <div className={styles.WantContainer}>
            <label className={styles.Label}> Skills I Want to Learn </label>
            <input className={styles.InputSmall} onChange={handleOnChange} name="want" />
            <input type="button" value="Adds"className={styles.Button} onClick={onAddTagWant}/>
            {want.map((wantTag) => (<div>{wantTag}</div>))}
            </div>
