...
function ProjectFeed() {
  ...
  useEffect(() => {
    axios
      .get("https://geeb.herokuapp.com/oprojects") ///"https://geeb.herokuapp.com/oprojects" https://geeb.herokuapp.comoprojects
  ...
  const myProjects = () => {
    axios
      ...
      }) //https://geeb.herokuapp.com/oprojects" https://geeb.herokuapp.comoprojects
      .then((response) => {
