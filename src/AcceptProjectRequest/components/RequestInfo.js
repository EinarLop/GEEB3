        ...
        <div>
            ...
            <div className="ParticipantInfo">
                ...
                <div className="GitAndLinkedIn">
                    <p>
                        GitHub: {personinfo.gitLink}
                    </p>
                    <p>
                        LinkedIn: {personinfo.linkedInLink}
                    </p>
                </div>
            </div>
            {//Tags
            ...
            <div className="TagsWrapper">
                ...
                <div >
                    {personinfo.tags.master.map(masterTag=>(
                        <p className="master" key={masterTag}>{masterTag}</p>
                    ))}
                    {personinfo.tags.learning.map(masterTag=>(
                        <p className="learning" key={masterTag}>{masterTag}</p>
                    ))}
                    {personinfo.tags.wantingToLearn.map(masterTag=>(
                        <p className="wantingToLearn" key={masterTag}>{masterTag}</p>
                    ))}
                </div>
            </div>
            ...
            { showInfo &&
                <div className="RequestWrapper">
                    ...
                    <div className="Buttons">
                        <button onClick={()=>botonAceptar(personinfo)}>
                            Acceptar
                        </button>
